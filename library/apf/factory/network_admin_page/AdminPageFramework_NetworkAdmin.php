...
abstract class AdminPageFramework_NetworkAdmin extends AdminPageFramework {
    ...
    protected $_aBuiltInRootMenuSlugs = array('APFMyFirstFrom' => 'index.php', 'sites' => 'sites.php', 'themes' => 'themes.php', 'plugins' => 'plugins.php', 'users' => 'users.php', 'settings' => 'settings.php', 'updates' => 'update-core.php',);
